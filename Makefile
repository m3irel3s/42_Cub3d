...
#    Updated: 2025/04/24 17:28:40 by jmeirele         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS        = ${SRC_PATH}/main.c \
				...
				${DRAW_PATH}/draw_minimap.c \
				${DRAW_PATH}/draw_minimap_utils.c \
				...
				${EVENTS_PATH}/try_moves.c \
				${EVENTS_PATH}/player_moves.c \
...
test2: all
	valgrind ${V_ARGS} ./${NAME} maps/invalid_maps/wall_none.cub
